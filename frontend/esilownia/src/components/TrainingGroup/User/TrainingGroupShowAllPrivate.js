...
function TrainingGroupShowAllPrivate() {
    ...
    return (
        <div className="trainingGroupShowAllPrivate">

            <div className="text-center">
                <hr></hr>
                <h1 style={{"fontSize": "5vw"}} className="display-1 font-weight-light mb-4">Treningi Personalne</h1>
                <hr></hr>
            </div>
...
export default TrainingGroupShowAllPrivate;