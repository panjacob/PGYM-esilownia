...
function Cechy_o_nas() {
    return (
        <div className="cechy_o_nas">
            <div className="row">
                <div className="col-md border rounded shadow m-1">
                    ...
                    <div className="row text-center mx-auto" style={{padding:"5% 15% 5% 15%"}}>
                        <p><b>Trenujesz w wybranym przez siebie miejscu. Bezpiecznie i w znajomym środowiksu bez fizycznego kontaku.</b></p>
                    </div>
                </div>
                <div className="col-md border rounded shadow m-1">
                    <div className="row justify-content-center" style={{padding:"10% 0% 0% 0%"}}>
            ...
            <div className="row">
                <div className="col-md border rounded shadow m-1">
                    ...
                    <div className="row text-center mx-auto" style={{padding:"5% 15% 5% 15%"}}>
                        <p><b>Plan i czas treningów jest w zupełnoci zależny od ciebie. Wybierasz z kim lub kiedy chcesz ćwiczyc.</b></p>
                    </div>
                </div>
                <div className="col-md border rounded shadow m-1">
                    <div className="row justify-content-center" style={{padding:"10% 0% 0% 0%"}}>
            ...
            <div className="row">
                ...
                <div className="col-md border rounded shadow m-1">
                    ...
                    <div className="row text-center mx-auto" style={{padding:"5% 15% 5% 15%"}}>
                        <p><b>Chcesz wypróbować inne ćwiczenia bez wykupywania treningu ? Mamy dla ciebie także filmy instruktażowe.</b></p>
                    </div>
                </div>
            </div>
        </div>
